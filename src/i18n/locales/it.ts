...
const it: Dictionary = {
  ...
  gebaeudetechnik: {
    ...
    items: [
      ...
      { title: 'Smantellamento impianti tecnici', desc: 'Smantellamento tecnico e demolizione industriale – dalla pianificazione alla consegna chiavi in mano.' },
    ],
  ...
  whatsapp: {
    ...
    subheader: 'Di solito rispondiamo entro pochi minuti',
    greeting: 'Ciao! 👋 Come posso aiutarti? Scrivici un messaggio e ti risponderemo il prima possibile.',
